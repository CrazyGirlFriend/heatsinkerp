...
import { ElButton, ElDescriptions, ElDescriptionsItem, ElDrawer, ElPagination, ElTable, ElTableColumn, ElTabs, ElTabPane } from 'element-plus'
...
const props = defineProps<{ modelValue: boolean; teamId: number; serialNo: string }>()
...
watch(() => [props.modelValue, props.teamId, props.serialNo], () => { ++version; summary.value = null; tab.value = 'stock'; page.value = 1; batchOpen.value = false; groupOpen.value = false; void load() })
