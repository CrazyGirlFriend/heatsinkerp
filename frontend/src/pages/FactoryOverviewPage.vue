...
<style scoped>
.factory-overview { --dashboard-surface: #fff; --dashboard-line: var(--line); --dashboard-muted: var(--muted); display: flex; flex-direction: column; gap: 14px; padding: 24px 28px 16px; color: var(--text); background: var(--workspace-bg); overflow-y: auto; }
.factory-heading { display: flex; flex-shrink: 0; align-items: center; justify-content: space-between; gap: 18px; flex-wrap: wrap; }.factory-heading h1 { margin: 0; font-size: 25px; line-height: 32px; font-weight: 600; letter-spacing: -.5px; }.factory-heading p { font-size: 12px; line-height: 18px; color: var(--dashboard-muted); margin: 5px 0 0; }
