...
<style scoped>
.scope-title { font-size: 14px; font-weight: 500; color: var(--muted); }
.team-preview-workspace { min-width: 0; }.team-preview-workspace > .identity-row { margin-bottom: 14px; padding: 0; }
.flow-preview-page { height: 100dvh; overflow: auto; background: var(--workspace-bg); color: var(--text); font-family: var(--font-body); }
...
.back-link { display: flex; align-items: center; gap: 9px; color: var(--muted); text-decoration: none; font-size: 14px; }.back-link:hover { color: var(--primary); }
...
.flow-column-labels { display: grid; grid-template-columns: repeat(3,1fr); padding: 26px 44px 2px; color: var(--subtle); font-size: 12px; letter-spacing: 1px; }.flow-column-labels > span:nth-child(2) { text-align: center; }.flow-column-labels > span:last-child { text-align: right; }.canvas-area { position: relative; min-height: 520px; background-image: radial-gradient(#e8eaf2 .6px, transparent .6px); background-size: 20px 20px; }
.preview-empty { min-height: 520px; display: flex; flex-direction: column; align-items: center; justify-content: center; color: var(--subtle); border: 1px solid var(--line); border-radius: var(--card-radius); background: #fff; margin-top: 24px; }.empty-orbit { display: grid; place-items: center; width: 72px; height: 72px; border: 1px solid var(--line); border-radius: 50%; box-shadow: 0 0 0 16px var(--surface-soft); color: var(--primary); font-size: 30px; margin-bottom: 20px; }.preview-empty h2 { font-size: 22px; font-weight: 500; color: var(--text); }.preview-empty p { font-size: 14px; }.zero-measure { height: 100%; display: grid; place-items: center; font-size: 15px; color: var(--muted); }
.selection-title { font-size: 20px; color: var(--text); font-weight: 550; overflow-wrap: anywhere; }.selection-description { color: var(--muted); font-size: 14px; line-height: 1.8; }.selection-amount { display: block; font-size: 24px; color: var(--primary); margin: 24px 0 32px; font-weight: 500; }.selection-label { color: var(--subtle); font-size: 12px; }.selection-batches { display: grid; gap: 10px; }.selection-batches button { border: 1px solid var(--line); border-radius: 7px; background: #fff; padding: 15px; text-align: left; cursor: pointer; display: grid; gap: 8px; font: inherit; }.selection-batches button:hover { border-color: #bdb0d9; background: var(--workspace-bg); }.selection-batches b { font-size: 14px; color: var(--primary); font-weight: 500; overflow-wrap: anywhere; }.selection-batches span { font-size: 13px; color: var(--text); }.selection-batches em { font-style: normal; font-size: 11px; color: var(--subtle); margin-left: 10px; }.selection-batches small { font-size: 12px; color: var(--subtle); }
.chain-page { display: flex; flex-direction: column; background: #fff; overflow: hidden; }
.chain-header { display: flex; align-items: center; flex-shrink: 0; gap: 28px; min-height: 76px; padding: 12px 24px 12px 16px; box-sizing: border-box; border-bottom: 1px solid var(--line); }
.chain-title { display: flex; align-items: center; gap: 8px; flex-shrink: 0; }.chain-title h1 { margin: 0; color: var(--text); font-size: 24px; font-weight: 550; letter-spacing: -.4px; }.chain-title .back-link { width: 40px; height: 40px; justify-content: center; border-radius: 8px; font-size: 18px; }.chain-title .back-link:hover { background: var(--surface-soft); }
.chain-query { display: flex; gap: 12px; width: 440px; min-width: 0; }.chain-query .el-input { flex: 1; min-width: 0; }.chain-query :deep(.el-input__wrapper), .chain-query .el-button { min-height: 42px; }.chain-query :deep(.el-input-group__prepend) { background: var(--workspace-bg); color: var(--muted); padding: 0 16px; box-shadow: 1px 0 0 0 var(--line) inset, 0 1px 0 0 var(--line) inset, 0 -1px 0 0 var(--line) inset; }.chain-asof { color: var(--muted); font-size: 14px; }
.chain-actions { display: flex; align-items: center; gap: 12px; margin-left: auto; white-space: nowrap; }.batch-count { color: var(--muted); font-size: 14px; font-variant-numeric: tabular-nums; }.sample-label, .data-warning { color: #99631f; font-size: 12px; }.chain-actions .header-icon { width: 36px; height: 36px; padding: 0; margin-left: 0; color: var(--muted); font-size: 17px; }
.canvas-help { font-size: 13px; line-height: 1.7; color: var(--muted); }.canvas-help p { margin: 8px 0; }
...
.canvas-controls { position: absolute; z-index: 6; left: 50%; bottom: 12px; transform: translateX(-50%); display: flex; align-items: center; gap: 8px; padding: 6px; width: max-content; max-width: calc(100% - 16px); box-sizing: border-box; border: 1px solid var(--line); border-radius: 18px; background: #fff; box-shadow: 0 8px 26px #1923330d, 0 2px 5px #19233306; }
.canvas-controls > div { display: flex; align-items: center; flex-shrink: 0; }
.canvas-controls > div + div { padding-left: 8px; border-left: 1px solid var(--line); }
.canvas-controls button, .selection-chip button { width: 44px; height: 44px; padding: 0; border: 0; border-radius: 12px; display: grid; place-items: center; flex-shrink: 0; background: transparent; color: var(--muted); cursor: pointer; transition: background-color 160ms, color 160ms, transform 160ms; }
.canvas-controls button:hover, .selection-chip button:hover { background: var(--surface-soft); color: var(--text); }
.canvas-controls button:active { transform: scale(.92); }
.canvas-controls button:focus-visible, .selection-chip button:focus-visible { outline: 2px solid var(--primary); outline-offset: 2px; }
...
.canvas-mode button[aria-pressed=true] { color: var(--text); background: transparent; }
.canvas-controls .zoom-level { min-width: 56px; color: var(--text); text-align: center; font-size: 13px; font-weight: 500; font-variant-numeric: tabular-nums; }
.selection-chip { position: absolute; z-index: 6; top: 6px; right: 12px; display: flex; align-items: center; gap: 8px; padding-left: 14px; border: 1px solid var(--line); border-radius: 10px; color: var(--primary); background: #fff; box-shadow: 0 3px 12px #22283a08; font-size: 13px; }
...
.chain-page--embedded { height: calc(100dvh - var(--topbar-height)); padding: 20px 24px; box-sizing: border-box; background: var(--workspace-bg); font-family: inherit; }
.chain-page--embedded .chain-header { min-height: 64px; padding: 12px 16px; gap: 16px; border: 1px solid var(--line); border-radius: 12px 12px 0 0; background: var(--surface); }
...
.chain-page--embedded .preview-main { padding: 0 16px 12px; border: 1px solid var(--line); border-top: 0; border-radius: 0 0 12px 12px; background: var(--surface); }
