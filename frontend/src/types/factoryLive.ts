...
export interface LiveTeam extends FactoryTeam {
  incoming: number | null; outgoing: number | null; pending_transfers: LiveTransfer[]
...
export interface LiveLink {
  source_id: number; target_id: number; pending_batches: number; confirmed_batches: number
  pending_quantity: number; pending_weight: number
}
